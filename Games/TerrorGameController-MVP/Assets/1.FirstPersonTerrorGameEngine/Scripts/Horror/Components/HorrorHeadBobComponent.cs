...
namespace HorrorEngine
{
    ...
    /// </summary>
    public class HorrorHeadBobComponent : MonoBehaviour
    {
        ...
        private void Awake()
        {
            if (joint == null)
            {
                Debug.LogWarning("HorrorHeadBobComponent: Joint Transform no asignado. Buscando automáticamente...");
            ...
            {
                Debug.LogError("HorrorHeadBobComponent: No se encontró Transform para headbob. Asigna un joint en el Inspector.");
            }
        }
